...
health = 4
imageFilePath = 'C:/Users/Anna/Pictures/Covidgotchi/'
...
#**************************game functions**************************
def slapChecks(task):
    global staticOutside, staticEat, staticDrink, staticStretch, taskChecks
    print("SLAPCHECKS" + str(taskChecks[0]))
    print("SLAPCHECKS TASKU" + str(task))
...
def timerStretch(): #task 0
    ...
    global taskChecks
    global staticStretch
    print("TRUK KUN " + str(currentTime - staticStretch))

    if currentTime - staticStretch > 10000 and taskChecks[0] ==  True: #3000000: #50 minutes
        removeCheckmark(0)
        print("STRETCH REMOVED") 
    elif currentTime - staticStretch > 5000: #3600000: #60 minutes
        addRedCheckmark(0)
        print("!!!!TASK 0 " + str(taskChecks[0]))
    slapChecks(0)
...
def timerDrink(): #task 1
    ...
    elif currentTime - staticDrink > 5000: #7200000: # 120 minutes   
        addRedCheckmark(1)
        print("!!!!TASK 1" + str(taskChecks[1]))
    slapChecks(1)
...
def timerEat(): #task 2
    ...
    if currentTime - staticEat > 20000 and taskChecks[2] == True: #12000000: # 200 minutes 
        removeCheckmark(2)
        print("EAT REMOVED") 
    elif currentTime - staticEat > 5000: #12600000: # 210 minutes 
        addRedCheckmark(2)
        print("!!!!TASK 2 " + str(taskChecks[2]))
    slapChecks(2)
...
def timerGoOutside(): #task 3
    ...
    elif currentTime - staticOutside > 5000: #21600000: # 360 minutes 
        addRedCheckmark(3)
        print("!!!!!TASK 3 " + str(taskChecks[3]))
    slapChecks(3)
...
def exitButton(x, y):
    ...
    if ((x > exitButtonLocation[0] and x < btmX) and (y > exitButtonLocation[1] and y < btmY)):
        #clicked on exit
       # escapeMenuScreen()
        print("was supposed to exit, not anymore")
...
while game:
 ...
 #   print(currentScreen)
    ...
    if currentScreen == 'Title':
        titleScreen()
        #pygame.draw.rect(screen, black, pygame.Rect(325, 500, 287.5, 125))
        #pygame.draw.rect(screen, black, pygame.Rect(200, 250, 82.5,400))
        # Rip black box T.T pygame.draw.rect(screen, black, pygame.Rect(30, 30, 60, 60)) #(325, 500), (612.5, 625)
        for event in pygame.event.get():
